import { inferEffect, makeCapitalized } from '../../../utils/index.js'

/**
 * Make Effect relation schema code from a relation schema AST extraction.
 *
 * @param schema - The relation schema to generate code for.
 * @param withType - Whether to include type definition.
 * @returns The generated Effect relation schema code.
 */
